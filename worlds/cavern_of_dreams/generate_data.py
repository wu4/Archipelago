...
from cavern_of_dreams_ap_logic.csv_parsing import read_locations_csv, FlagListIteration, FlagList, FlagListWithLocations
...
if __name__ == "__main__":
    ...
    accum.append("# Generated using generate_data.py")
    accum += parse(location_datas)
    with open("generated/data.py", "w") as out_py:
        out_py.write("\n".join(accum))