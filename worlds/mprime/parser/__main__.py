...
from .util import trick_name_gen, relative_to_file, absolute_location_tuple_format
...
if __name__ == "__main__":
    ...
    for template_name in ["options","regions","rules"]:
    ...
    builder.append(f"from . import options,regions,rules")
